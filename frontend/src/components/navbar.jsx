      ...
      <div className="max-w-screen-xl px-4 mx-auto 2xl:px-0 py-4">
          ...
          <div className="flex items-center space-x-8">
            <ul className="hidden lg:flex items-center justify-start gap-6 md:gap-8 py-3 sm:justify-center">
              ...
              <li className="shrink-0">
                <p className="flex text-sm font-medium text-gray-900 hover:text-primary-700 dark:text-white dark:hover:text-primary-500">
                  Best Sellers
                </p>
              </li>
              <li className="shrink-0">
              ...
              <li className="shrink-0">
                <p className="text-sm font-medium text-gray-900 hover:text-primary-700 dark:text-white dark:hover:text-primary-500">
                  Today's Deals
                </p>
              </li>
              <li className="shrink-0">
        ...
        <div className="lg:justify-end lg:flex md:flex md:justify-end">
          ...
          <div
            ...
            } z-10 absolute mx-auto max-w-sm space-y-4 overflow-hidden rounded-lg bg-white p-4 shadow-lg`}
          >
          ...
          <div
            ...
            } z-10 absolute w-56 divide-y divide-gray-100 overflow-hidden overflow-y-auto rounded-lg bg-white mt-4 shadow`}
          >
            {token ? (
              <ul className="p-2 text-start text-sm font-medium text-gray-900">
                <li>
                  <p className="inline-flex md:text-sm w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600">
                    My Account
                  </p>
                </li>
                <li>
                ...
                <li>
                  <p className="inline-flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600">
                    Settings
                  </p>
                </li>
                <li>
              ...
              <ul className="p-2 text-start text-sm font-medium text-gray-900">
                <li>
                  <a
                    href="/login"
                    title=""
                    className="inline-flex md:text-sm w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600"
                  >
                    Login
                  </a>
                </li>
        ...
        <div
          ...
          } z-10 absolute w-full bg-gray-50 dark:bg-gray-700 dark:border-gray-600 border border-gray-200 rounded-lg py-3 px-4 mt-4`}
        >
          <ul className="text-gray-900 md:text-xl text-sm font-medium space-y-3">
            ...
            <li>
              <p className="hover:text-primary-700 dark:hover:text-primary-500">
                Best Sellers
              </p>
            </li>
            <li>
