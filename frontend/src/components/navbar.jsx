        ...
        <nav className="bg-white dark:bg-gray-800 antialiased">
            <div className="max-w-screen-xl px-4 mx-auto 2xl:px-0 py-4">
                ...
                <div id="myCartDropdown1"
                     className={` ${isDropdownOpen ? " " : "hidden"} z-50  mx-auto max-w-sm space-y-4 overflow-hidden rounded-lg bg-white p-4  shadow-lg `}>
                ...
                <div id="userDropdown1"
                     className={` ${isUserDropdownOpen ? " " : "hidden"}  w-56 divide-y divide-gray-100 overflow-hidden overflow-y-auto rounded-lg bg-white mt-4 shadow`}>
                ...
                <div id="ecommerce-navbar-menu-1"
                     className={` ${isMobileMenuOpen ? "" : "hidden"}  bg-gray-50 dark:bg-gray-700 dark:border-gray-600 border border-gray-200 rounded-lg py-3  px-4 mt-4 `}>
