...
import { getCategories } from "../servers/product";
   ...
   useEffect(() => {
    ...
    return (
        ...
        <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
            ...
            <button id="categoryButton" classNameName="w-fit gap-4 mb-4 flex items-center md:mb-8">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">Shop by category</h2>
            <svg className="h-5 w-5 mt-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
          ...
          <div id="main" className={` ${isCLicked? ' ': 'hidden'} grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4`}>
