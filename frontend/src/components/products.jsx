...
<div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
  ...
  <div className="mb-4 items-end justify-between space-y-4 sm:flex sm:space-y-0 md:mb-8">
    ...
    <div className="flex items-center space-x-4">
      <button id='filterButton' data-modal-toggle="filterModal" data-modal-target="filterModal" type="button" className="flex w-full items-center justify-center rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700 sm:w-auto">
      ...
      <div id="dropdownSort1" className={`${isSortOpen? ' ': 'hidden' } z-10 absolute mt-72 w-40 divide-y divide-gray-100 rounded-lg bg-white shadow dark:bg-gray-700`} data-popper-placement="bottom" >
  ...
  <div className="relative h-full w-full max-w-xl md:h-auto">
    ...
    <div className="relative rounded-lg bg-white shadow dark:bg-gray-800">
      ...
      <div className="flex items-start justify-between rounded-t p-4 md:p-5">
        ...
        <button id='closeButton' type="button" className="ml-auto inline-flex items-center rounded-lg bg-transparent p-1.5 text-sm text-gray-400 hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="filterModal">
          <svg className="h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
      ...
      <div className="px-4 md:px-5">
        ...
        <div className="mt-4 space-y-4" id="advanced-filters" role="tabpanel" aria-labelledby="advanced-filters-tab">
