          ...
          <div className="mb-4 items-end justify-between space-y-4 sm:flex sm:space-y-0 md:mb-8">
            ...
            <div className="flex items-center space-x-4">
              ...
              >
                ...
                >
                  <li>
                    <p className="group inline-flex w-full items-center rounded-md px-3 py-2 text-sm text-gray-500 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white">
                      The most popular
                    </p>
                  </li>
                  <li>
                    ...
                    <div className="flex items-center justify-end gap-1">
                      ...
                      >
                        ...
                        <svg
                          ...
                          fill={
                            isFavorited(product.id) ? "currentColor" : "none"
                          }
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                      ...
                      <li>
                        ...
                        >
                          <div className="block">
                            ...
                            <div className="w-full">Delivery only form USA</div>
                          </div>
                        </label>
                      </li>
                      <li>
