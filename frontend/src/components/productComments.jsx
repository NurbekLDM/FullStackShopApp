  ...
  return (
    <div>
              ...
              <div className="divide-y divide-gray-200 dark:divide-gray-700">
                <div className="grid md:grid-cols-12 gap-4 md:gap-6 pb-4 md:pb-6">
                  ...
                  <div className="md:col-span-3 content-center order-1 md:order-3 flex items-center justify-between">
                    ...
                    <div
                      ...
                      className={`z-10 ${
                        isOpen ? "" : "hidden"
                      } z-10 absolute mt-32  ml-36 w-40 divide-y divide-gray-100 rounded-lg bg-white shadow dark:bg-gray-700" data-popper-placement="bottom`}
                    >
                      <ul
                ...
                <div className="grid md:grid-cols-12 gap-4 md:gap-6 py-4 md:py-6">
                  ...
                  <dl className="md:col-span-6 order-4 md:order-2">
                    <dt className="sr-only">Message:</dt>
                    <dd className=" text-gray-500 dark:text-gray-400">
                      The camera system continues to excel, capturing
                ...
                <div className="grid md:grid-cols-12 gap-4 md:gap-6 py-4 md:py-6">
                  <dl className="md:col-span-3 order-3 md:order-1">
                    ...
                    <dd className="text-base font-semibold text-gray-900 dark:text-white">
                      <a href="#" className="hover:underline">
                        Sony a7 III (ILCEM3K/B) Full-frame Mirror less
                      </a>
                    </dd>
                  </dl>
                  ...
                  <dl className="md:col-span-6 order-4 md:order-2">
                    <dt className="sr-only">Message:</dt>
                    <dd className=" text-gray-500 dark:text-gray-400">
                      The Sony a7 III is a versatile mirrorless camera that
                      excels in both photo and video quality...
                    </dd>
                  </dl>
                ...
                <div className="grid md:grid-cols-12 gap-4 md:gap-6 pt-4 md:pt-6">
                  ...
                  <dl className="md:col-span-6 order-4 md:order-2">
                    <dt className="sr-only">Message:</dt>
                    <dd className=" text-gray-500 dark:text-gray-400">
                      The inkjet printer has been a frustrating experience.
                      Print quality is inconsistent, with colors often...
                    </dd>
                  </dl>
      ...
      <div
        ...
        className={`${
          isDeleted ? "" : "hidden"
        } fixed flex left-0 right-0 top-0 z-50  h-modal w-full items-center justify-center overflow-y-auto overflow-x-hidden md:inset-0 md:h-full`}
      >
      ...
      <div
        ...
        className={`${
          isEdited ? "" : "hidden"
        } fixed flex  left-0 right-0 top-0 z-50  h-[calc(100%-1rem)] max-h-full w-full items-center justify-center overflow-y-auto overflow-x-hidden md:inset-0 antialiased`}
      >
