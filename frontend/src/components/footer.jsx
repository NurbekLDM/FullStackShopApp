  ...
  <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
      ...
      <div className="items-start gap-6 md:gap-8 lg:flex 2xl:gap-24">
        <div className="grid min-w-0 flex-1 grid-cols-2 gap-6 md:gap-8 xl:grid-cols-3">
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#" title="" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white"> Premium </a>
              </li>
        ...
        <div className="mt-6 w-full md:mt-8 lg:mt-0 lg:max-w-lg">
          <div className="space-y-5 rounded-lg bg-gray-50 p-6 dark:bg-gray-700">
            ...
            <form action="#">
              <div className="items-end space-y-4 sm:flex sm:space-y-0">
                <div className="relative mr-3 w-full sm:w-96 lg:w-full">
                  <label for="email" className="mb-2 block text-sm font-medium text-gray-900 dark:text-gray-300"> Get the latest deals and more. </label>
            ...
            <div>
              <p className="mb-3 text-sm font-medium text-gray-900 dark:text-white">Trade on the go with <a href="#" title="" className="underline hover:no-underline">Company App</a></p>
    ...
    <div className="py-6 md:py-8">
      <div className="gap-4 space-y-5 xl:flex xl:items-center xl:justify-between xl:space-y-0">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">© {year} <a href="#" className="hover:underline">Company</a>, Inc. All rights reserved.</p>
      </div>
    </div>
  </div>
</footer>
