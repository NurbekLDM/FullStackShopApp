...
export default function AdminPanelNavbar() {
    ...
    return (
        ...
        <div>
            ...
            <button data-drawer-target="default-sidebar" id='sidebarBtn' data-drawer-toggle="default-sidebar"
            ...
            <aside id="default-sidebar"
                ...
                <div
                    className=" absolute bottom-0 left-0 justify-center p-4 space-x-4 w-full lg:flex bg-white dark:bg-gray-800 z-20 border-r border-gray-200 dark:border-gray-700">
                    <a href="#"
                    ...
                    <button type="button"
                        ...
                        <svg aria-hidden="true" className="h-5 w-5 rounded-full mt-0.5"
            ...
            <div id="mobile-sidebar"
                   className={`absolute ${isMobileMenu ? '' : 'hidden'} top-16  left-0 z-10 w-fit h-fit transition-transform-translate-x-full `}
                   aria-label="Sidenav">
                <div
                    className="overflow-y-auto   px-3 h-full bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                    <ul className="mr-10">
                        <li>
                            <a href="#"
                               className="flex items-center p-2 text-xs font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                <svg aria-hidden="true"
                        ...
                        <li>
                            <a href=""
                               className="flex items-center p-2 w-full text-xs font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                                <svg aria-hidden="true"
                        ...
                        <li>
                            ...
                            <a href="#"
                               className="flex items-center w-full p-2 text-xs font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                <svg aria-hidden="true"
                    ...
                    <ul className=" mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
                        <li>
                            <a href="#"
                               className="flex items-center p-2 text-xs font-normal text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
                                <svg aria-hidden="true"
                                     className="flex-shrink-0 w-5 h-5 text-gray-400 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                     fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9z"></path>
                ...
                <div
                    className=" pt-8  left-0 justify-center space-x-4 w-full lg:flex bg-white dark:bg-gray-800 z-20 border-r border-gray-200 dark:border-gray-700">
                    <a href="#"
                       className="inline-flex justify-center p-2 text-gray-500 rounded cursor-pointer dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-600">
                        <svg aria-hidden="true" className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                             xmlns="http://www.w3.org/2000/svg">
